...
static const float bg_color_value_alt_diff = 0.08; // changed from 0.12 (maybe broke some stuff that like color gray but you can restore this to be 0.12 if you want
